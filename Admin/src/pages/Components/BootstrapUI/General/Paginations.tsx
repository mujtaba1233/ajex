                    ...
                    <Card>
                        ...
                        <Card.Body>
                            <div>
                                <Row>
                                    <Col lg={6}>
                                        <h5 className="fs-md">Default Pagination</h5>
                                    ...
                                    <Col lg={6}>
                                        <div className="mt-4 mt-lg-0">
                                            <h5 className="fs-md">Disabled and Active states</h5>
                                ...
                                <Row>
                                    ...
                                    <Col lg={6}>
                                        <div className="mt-4">
                                            <h5 className="fs-md">Alignment</h5>
                                ...
                                <Row>
                                    <Col lg={6}>
                                        <div className="mt-4">
                                            <h5 className="fs-md">Custom Separated Pagination</h5>
                                    ...
                                    <Col lg={6}>
                                        <div className="mt-4">
                                            <h5 className="fs-md">Custom Rounded Pagination</h5>
