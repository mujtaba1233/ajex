...
<!-- Prgress sm -->
<div className="mb-4">
    <h5 className="fs-sm">Small Progress</h5>
    <ProgressBar now={25} className="progress-sm" />
</div>

<!-- Prgress Default -->
<div className="mb-4">
    <h5 className="fs-sm">Default Progress </h5>
    <ProgressBar variant='success' now={40} />
</div>

<!-- Prgress lg -->
<div className="mb-4">
    <h5 className="fs-sm">Large Progress</h5>
    <ProgressBar variant='warning' now={25} className="progress-lg" />
</div>

<!-- Prgress xl -->
<div>
    <h5 className="fs-sm">Extra Large Progress</h5>
...
<div className="d-flex align-items-center pb-2 mt-4">
    <div className="flex-shrink-0 me-3">
        <div className="avatar-xs">
            <div className="avatar-title bg-light rounded-circle text-muted fs-lg">
