                            ...
                            <Row>
                                ...
                                <Col lg={6}>
                                    <div className="d-flex flex-wrap align-items-center gap-2">
                                        ...
                                        <Button variant='subtle-warning' className="custom-toggle active" onClick={(e) => toggleBtn(e.target)}>
                                            <span className="icon-on">Follow</span>
                                            <span className="icon-off">Unfollow</span>
                                        </Button>
                                        <Button variant='subtle-danger' className="custom-toggle" onClick={(e) => toggleBtn(e.target)}>
                                            <span className="icon-on">On</span>
                                            <span className="icon-off">Off</span>
                                        </Button>
