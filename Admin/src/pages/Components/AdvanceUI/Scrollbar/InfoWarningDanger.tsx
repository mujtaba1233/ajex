                                ...
                                <SimpleBar autoHide={false} style={{ maxHeight: "220px" }} data-simplebar-track="warning" className="px-3">
                                    <div className="d-flex align-items-center py-3">
                                        ...
                                        <div className="flex-grow-1">
                                            <div>
                                                <h5 className="fs-md mb-1">Esther James</h5>
                                    ...
                                    <div className="d-flex align-items-center py-3">
                                        ...
                                        <div className="flex-grow-1">
                                            <div>
                                                <h5 className="fs-md mb-1">Jacqueline Steve</h5>
                                    ...
                                    <div className="d-flex align-items-center py-3">
                                        ...
                                        <div className="flex-grow-1">
                                            <div>
                                                <h5 className="fs-md mb-1">George Whalen</h5>
                                    ...
                                    <div className="d-flex align-items-center py-3">
                                        ...
                                        <div className="flex-grow-1">
                                            <div>
                                                <h5 className="fs-md mb-1">Carl Lynch</h5>
                                                <p className="text-muted mb-0">Frontend Developer</p>
                                            </div>
                                        </div>
                                        <div className="flex-shrink-0 ms-2">
                                ...
                                <SimpleBar autoHide={false} style={{ maxHeight: "220px" }} className="px-3" data-simplebar-track="danger">
                                    <Link to="#" className="d-flex align-items-center py-2">
                                        ...
                                        <div className="flex-grow-1 overflow-hidden">
                                            <h5 className="fs-md mb-1">ABC Project Customization</h5>
                                            <p className="text-muted mb-0">04 Members</p>
                                        </div>
                                        <div className="flex-shrink-0 align-self-start ms-2">
                                            <div className="badge bg-warning-subtle text-warning fs-2xs">Inprogress</div>
                                        </div>
                                    </Link>
                                    <Link to="#" className="d-flex align-items-center py-2">
                                        <div className="flex-shrink-0 avatar-xs me-3">
                                        ...
                                        <div className="flex-grow-1 overflow-hidden">
                                            <h5 className="fs-md mb-1">Client - John</h5>
                                    ...
                                    <Link to="#" className="d-flex align-items-center py-2">
                                        ...
                                        <div className="flex-grow-1 overflow-hidden">
                                            <h5 className="fs-md mb-1">Brand logo Design</h5>
                                            <p className="text-muted mb-0">01 Members</p>
                                        </div>
                                        <div className="flex-shrink-0 align-self-start ms-2">
                                            <div className="badge bg-success-subtle text-success fs-3xs">Completed</div>
                                        </div>
                                    </Link>
                                    <Link to="#" className="d-flex align-items-center py-2">
                                        <div className="flex-shrink-0 avatar-xs me-3">
                                        ...
                                        <div className="flex-grow-1 overflow-hidden">
                                            <h5 className="fs-md mb-1">Project update</h5>
                                    ...
                                    <Link to="#" className="d-flex align-items-center py-2">
                                        ...
                                        <div className="flex-grow-1 overflow-hidden">
                                            <h5 className="fs-md mb-1">Chat App</h5>
