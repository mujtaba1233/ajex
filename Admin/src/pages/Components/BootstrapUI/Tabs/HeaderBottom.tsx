                                        ...
                                        <Row>
                                            <Col sm="6">
                                                <div className="d-flex">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <h6 className="mb-1 fs-md">Dominic Charlton</h6>
                                                ...
                                                <div className="d-flex mt-3">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <h6 className="mb-1 fs-md">Charlie Pritchard</h6>
                                                ...
                                                <div className="d-flex mt-3">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <h6 className="mb-1 fs-md">Harvey Wells</h6>
                                            ...
                                            <Col sm="6">
                                                <div className="d-flex mt-3 mt-sm-0">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <h6 className="mb-1 fs-md">Amelie Townsend</h6>
                                                ...
                                                <div className="d-flex mt-3">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <h6 className="mb-1 fs-md">Emily Slater</h6>
                                                ...
                                                <div className="d-flex mt-3">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <h6 className="mb-1 fs-md">Declan Long</h6>
                                        ...
                                        <Row>
                                            <Col sm="6">
                                                <div className="d-flex">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <h6 className="mb-1 fs-md">Luke Brown</h6>
                                                ...
                                                <div className="d-flex mt-3">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <h6 className="mb-1 fs-md">Matilda Walker</h6>
                                                ...
                                                <div className="d-flex mt-3">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <h6 className="mb-1 fs-md">Leo Stokes</h6>
                                            ...
                                            <Col sm="6">
                                                <div className="d-flex mt-3 mt-sm-0">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <h6 className="mb-1 fs-md">Chelsea Preston</h6>
                                                ...
                                                <div className="d-flex mt-3">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <h6 className="mb-1 fs-md">Jennifer Barker</h6>
                                                ...
                                                <div className="d-flex mt-3">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <h6 className="mb-1 fs-md">Callum Murray</h6>
                    ...
                    <Card>
                        <Tab.Container defaultActiveKey="bottomtabs-home">
                            ...
                            <Card.Footer className="bg-transparent border-top">
                                ...
                                <Nav as="ul" variant='pills' className="nav-justified card-footer-tabs fs-base" role="tablist">
                                    <Nav.Item as="li">
