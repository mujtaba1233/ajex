                                        ...
                                        <Row className="gallery-light">
                                            <Col xl={3} lg={4} sm={6}>
                                                ...
                                                <div className="gallery-container">
                                                        <Link to="#" title="">
                                                            <Image className="gallery-img img-fluid mx-auto" src={img12} alt="" />
                                                        </Link>
                                                    </div>
                                                        ...
                                                        <div className="d-flex align-items-center mt-1">
                                                            ...
                                                            <div className="flex-shrink-0">
                                                                <div className="d-flex gap-3">
                                                                    <Button className="btn-sm fs-xs btn-link text-body text-decoration-none px-0 btn-light">
                                            ...
                                            <Col xl={3} lg={4} sm={6}>
                                                ...
                                                <div className="gallery-container">
                                                        <Link to="#" title="">
                                                            <Image className="gallery-img img-fluid mx-auto" src={img11} alt="" />
                                                        </Link>
                                                    </div>
                                                    <div className="box-content px-3 py-2">
                                                        <div className="gallery-overlay">
