                ...
                <tr>
                    ...
                    <td>
                        <div className="hstack gap-3 flex-wrap">
                            <Link to="#" className="link-success fs-md"><i className="ri-edit-2-line"></i></Link>
                            <Link to="#" className="link-danger fs-md"><i className="ri-delete-bin-line"></i></Link>
                        </div>
                    </td>
                </tr>
                <tr>
        ...
        <Table className="table-hover align-middle table-nowrap mb-0">
            ...
            <tbody>
                <tr>
                    ...
                    <td>Cleo Carson</td>
                    <td>$4,521</td>
                    <td><Link to="#"><i className="ri-download-2-line fs-base lh-1 align-middle"></i></Link></td>
                </tr>
                <tr>
                    <th scope="row">
                        <div className="form-check">
...
<Table className="align-middle table-nowrap mb-0">
    ...
    <tbody>
        <tr>
            ...
            <td>10 Oct, 14:47</td>
            <td className="text-success"><i className="ri-checkbox-circle-line fs-base align-middle"></i> Paid</td>
            <td>
        ...
        <tr>
            ...
            <td>26 Oct, 08:20</td>
            <td className="text-primary"><i className="ri-refresh-line fs-base align-middle"></i> Refunded</td>
            <td>
                <div className="d-flex gap-2 align-items-center">
                    <div className="flex-shrink-0">
        ...
        <tr>
            ...
            <td>02 Nov, 04:52</td>
            <td className="text-danger"><i className="ri-close-circle-line fs-base align-middle"></i> Cancel</td>
            <td>
                <div className="d-flex gap-2 align-items-center">
                    <div className="flex-shrink-0">
