                ...
                <div className="col-12">
                    ...
                    <Row>
                        <Col xxl={4} lg={6}>
                            <Card>
                                <Card.Header>
                                    <button type="button" className="btn-close float-end fs-2xs" aria-label="Close"></button>
                                ...
                                <Card.Body>
                                    <blockquote className="card-blockquote mb-0">
                                        ...
                                        <figure className="mb-0">
                                            ...
                                            <figcaption className="blockquote-footer fs-sm text-end mb-0">
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-shrink-0">
                                    <ul className="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                                        ...
                                        <li className="list-inline-item">
                                            <button onClick={() => delthis('card-none1')} className="btn-close fs-3xs align-middle"></button>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-shrink-0">
                                    <ul className="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                                        ...
                                        <li className="list-inline-item">
                                            <button type="button" onClick={() => delthis('card-none2')} className="btn-close fs-3xs align-middle"></button>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-shrink-0">
                                    <ul className="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                                        ...
                                        <li className="list-inline-item">
                                            <button type="button" onClick={() => delthis('card-none3')} className="btn-close fs-3xs align-middle"></button>
                                        </li>
                                    </ul>
                                </div>
