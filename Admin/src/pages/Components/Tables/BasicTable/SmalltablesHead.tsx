                                ...
                                <Table className="table-sm table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><Badge className="badge bg-primary-subtle text-primary">Backlog</Badge></td>
                                            <td>Lanora Sandoval</td>
                                        </tr>
                                        <tr>
                                            <td className="fw-medium">02</td>
                                            <td>Design syntax</td>
                                            <td><Badge className="badge bg-secondary-subtle text-secondary">In Progress</Badge></td>
                                            <td>Calvin Garrett</td>
                                        </tr>
                                        <tr>
                                            <td className="fw-medium">03</td>
                                            <td>Configurable resources</td>
                                            <td><Badge className="badge bg-success-subtle text-success">Done</Badge></td>
                                            <td>Florence Guzman</td>
                                        </tr>
                                        <tr>
                                            <td className="fw-medium">04</td>
                                            <td>Implement extensions</td>
                                            <td><Badge className="badge bg-dark-subtle text-dark">Backlog</Badge></td>
