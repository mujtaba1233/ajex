        ...
        <React.Fragment>
            ...
            >
                ...
                <Modal.Body className="text-center p-5">
                         <i className="ph ph-confetti display-5 text-success"></i>
                    <div className="mt-4">
                        ...
                        <div className="hstack gap-2 justify-content-center">
                            <Link to="#" className="btn btn-link link-danger fw-medium" onClick={() => setmodal_backdrop(false)}><i className="ri-close-line me-1 align-middle"></i> Close</Link>
