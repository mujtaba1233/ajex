      ...
      },
      {
        ...
        accessor: (cellProps: any) => {
          switch (cellProps.status) {
            case "Paid":
              return (<span className="badge bg-success-subtle text-uppercase text-success"> {cellProps.status}</span>)
            case "Refund":
              return (<span className="badge bg-warning-subtle text-uppercase text-warning"> {cellProps.status}</span>)
            default:
              return (<span className="badge bg-danger-subtle text-uppercase text-danger"> {cellProps.status}</span>)
          }
        },
      },
      {
