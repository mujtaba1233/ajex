                                    ...
                                    <div className="mx-n3">
                                        <SimpleBar autoHide={false} data-simplebar-track="primary" style={{ maxHeight: "275px" }}>
                                            ...
                                            <div className="text-center my-2">
                                                <Link to="#" className="text-success"><i className="mdi mdi-loading mdi-spin fs-2xl align-middle me-2"></i> Load more </Link>
                                            </div>
                                        </SimpleBar>
                                    </div>
                                </Card.Body>
                                            ...
                                            <div className="list-group list-group-flush">
                                                <Link to="#" className="list-group-item text-muted py-3">
                                                    <div className="d-flex align-items-start">
                                                        ...
                                                        <div className="flex-grow-1 overflow-hidden">
                                                            <h5 className="text-truncate fs-md mb-1">Michael Johnston</h5>
                                                            <p className="text-truncate mb-0">New updates for ABC Theme</p>
                                                        </div>
                                                        <div className="fs-xs">06 mins</div>
                                                    </div>
                                                </Link>
                                                <Link to="#" className="list-group-item text-muted py-3">
                                                    <div className="d-flex align-items-start">
                                                        ...
                                                        <div className="flex-grow-1 overflow-hidden">
                                                            <h5 className="text-truncate fs-md mb-1">Darren James</h5>
                                                            <p className="text-truncate mb-0">Bug Report - abc theme</p>
                                                        </div>
                                                        <div className="fs-xs">12 mins</div>
                                                    </div>
                                                </Link>
                                                <Link to="#" className="list-group-item text-muted py-3">
                                                    <div className="d-flex align-items-start">
                                                        ...
                                                        <div className="flex-grow-1 overflow-hidden">
                                                            <h5 className="text-truncate fs-md mb-1">Patricia Shelton</h5>
                                                            <p className="text-truncate mb-0">Nice to meet you</p>
                                                        </div>
                                                        <div className="fs-xs">28 mins</div>
                                                    </div>
                                                </Link>
                                                ...
                                                <Link to="#" className="list-group-item text-muted py-3">
                                                    <div className="d-flex align-items-start">
                                                        ...
                                                        <div className="flex-grow-1 overflow-hidden">
                                                            <h5 className="text-truncate fs-md mb-1">Thomas McNeil</h5>
                                                            <p className="text-truncate mb-0">This theme is awesome!</p>
                                                        </div>
                                                        <div className="fs-xs">02 hrs</div>
                                                    </div>
                                                </Link>
                                                ...
                                                <Link to="#" className="list-group-item text-muted py-3">
                                                    <div className="d-flex align-items-start">
                                                        ...
                                                        <div className="flex-grow-1 overflow-hidden">
                                                            <h5 className="text-truncate fs-md mb-1">Carolyn Jones</h5>
                                                            <p className="text-truncate mb-0">I've finished it! See you so</p>
                                                        </div>
                                                        <div className="fs-xs">03 hrs</div>
                                                    </div>
                                                </Link>
                                                <Link to="#" className="list-group-item text-muted py-3">
                                                    <div className="d-flex align-items-start">
                                            ...
                                            <ul className="list-group list-group-flush">
                                                <li className="list-group-item py-3">
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div className="flex-grow-1 text-muted overflow-hidden">
                                                            <h5 className="text-truncate fs-md mb-1">Lead designer / Developer</h5>
                                                ...
                                                <li className="list-group-item py-3">
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div className="flex-grow-1 text-muted overflow-hidden">
                                                            <h5 className="text-truncate fs-md mb-1">Senior Graphic Designer</h5>
                                                ...
                                                <li className="list-group-item py-3">
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div className="flex-grow-1 text-muted overflow-hidden">
                                                            <h5 className="text-truncate fs-md mb-1">Graphic Designer</h5>
                                                            <div className="text-truncate">Xyz Company</div>
                                                        </div>
                                                    </div>
                                                </li>
